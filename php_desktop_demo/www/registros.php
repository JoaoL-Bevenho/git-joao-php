...
<html lang="en">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <div class="divBtnAdicionar">
                  <button class="btn-adicionar btn" data-toggle="modal" data-target="#insertModal">Cadastrar Novo Registro</button>
                  <button class="btn-adicionar btn btn-adicionar-margin" data-toggle="modal" data-target="#arquivoModal">Processar Arquivo de Registros</button>
                  <button class="btn-adicionar btn" data-toggle="modal" data-target="#sqlatualizaModal">Lançar Atualização de Base de Dados</button>
                  <button class="btn-adicionar btn" data-toggle="modal" data-target="#jsonatualizarModal">Atualizar Arquivo .JSON</button>
                </div>
    ...
    <div class="modal fade" id="insertModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <?php
            if(($_SERVER["REQUEST_METHOD"] == "POST") && (!empty($_POST['registronomeInsert'])) && (!empty($_POST['registrotelefoneInsert'])) && (!empty($_POST['registroenderecoInsert'])) && (!empty($_POST['registronumeroInsert'])) && (!empty($_POST['tiposregistroopcoesInsert'])) && (!empty($_POST['registroisclienteInsert'])))
            {
              ...
              { 
                $sqlTextInsertRegistro = "INSERT INTO agendalocal.clientes(id_cidade, id_tiporegistro, nome, telefone, endereco, numero, atividade, is_cliente) VALUES(".(int)$_SESSION['city_id'].", ".(int)$tipo_registro.", '".$nome_registro."', '".$telefone_registro."', '".$endereco_registro."', '".$numero_registro."', '".$atividade_registro."', 1)";
                $sqlStmtInsertRegistro = $sqlTextInsertRegistro;
              }
              else if($iscliente_registro == "2")
              {
                $sqlTextInsertRegistro = "INSERT INTO agendalocal.clientes(id_cidade, id_tiporegistro, nome, telefone, endereco, numero, atividade, is_cliente) VALUES(".(int)$_SESSION['city_id'].", ".(int)$tipo_registro.", '".$nome_registro."', '".$telefone_registro."', '".$endereco_registro."', '".$numero_registro."', '".$atividade_registro."', 0)";
                $sqlStmtInsertRegistro = $sqlTextInsertRegistro;
              }
            ...
            <div class="modal-body">
              <div class="form-group">
                <div class="form-label-group">
                  ...
                  <input type="file" id="recordfileInsertBtn" name="registroArquivoInsertBtn"><br>
                </div>
              </div>
            </div>
            <div class="modal-footer">
              ...
              foreach($registrosXML as $registroXML)
              {
                if($registroXML_proximo == true)
                {
                  ...
                  if((!is_null($id_cidade)) && (!empty($nome_cidade)) && (!is_null($id_tiporegistro)) && (!empty($telefone_registro)) && (!empty($nome_registro)) && (!empty($endereco_registro)) && (!empty($numero_registro)) && (!is_null($iscliente_registro)))
                  {
                    ...
                    if($iscliente_registro == "1")
                    { 
                      $sqlTextInsertRegistro = "INSERT INTO agendalocal.clientes(id_cidade, id_tiporegistro, nome, telefone, endereco, numero, atividade, is_cliente) VALUES(".(int)$id_cidade.", ".(int)$id_tiporegistro.", '".$nome_registro."', '".$telefone_registro."', '".$endereco_registro."', '".$numero_registro."', '".$atividade_registro."', 1)";
                      $sqlStmtInsertRegistro = $sqlTextInsertRegistro;
                    }
                    else if($iscliente_registro == "0")
                    {
                      $sqlTextInsertRegistro = "INSERT INTO agendalocal.clientes(id_cidade, id_tiporegistro, nome, telefone, endereco, numero, atividade, is_cliente) VALUES(".(int)$id_cidade.", ".(int)$id_tiporegistro.", '".$nome_registro."', '".$telefone_registro."', '".$endereco_registro."', '".$numero_registro."', '".$atividade_registro."', 0)";
                      $sqlStmtInsertRegistro = $sqlTextInsertRegistro;
                    }
                    if($resultStmtInsertRegistro = pg_prepare($db_connection,"",  $sqlStmtInsertRegistro))
                    {
  ...
  <script type="text/javascript">
    ...
    { document.getElementById('logoutConfirm').value = "yes"; }
