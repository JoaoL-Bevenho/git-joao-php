...
--
-- Name: usuario_anuncio; Type: TABLE; Schema: agendalocal; Owner: postgres
--

CREATE TABLE agendalocal.usuario_anuncio (
    user_id integer,
    id_cidade integer,
...
ALTER TABLE agendalocal.usuario_anuncio OWNER TO postgres;

--
-- Name: usuario_anuncio_id_seq; Type: SEQUENCE; Schema: agendalocal; Owner: postgres
--

CREATE SEQUENCE agendalocal.usuario_anuncio_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE agendalocal.usuario_anuncio_id_seq OWNER TO postgres;

--
-- Name: usuario_anuncio_id_seq; Type: SEQUENCE OWNED BY; Schema: agendalocal; Owner: postgres
--

ALTER SEQUENCE agendalocal.usuario_anuncio_id_seq OWNED BY agendalocal.usuario_anuncio.id;


--
-- Name: usuario_mensagem; Type: TABLE; Schema: agendalocal; Owner: postgres
--

CREATE TABLE agendalocal.usuario_mensagem (
    user_id integer,
    id integer NOT NULL,
    mensagem text,
    data text NOT NULL
...
ALTER TABLE agendalocal.usuario_mensagem OWNER TO postgres;

--
-- Name: usuario_mensagem_data_seq; Type: SEQUENCE; Schema: agendalocal; Owner: postgres
--

CREATE SEQUENCE agendalocal.usuario_mensagem_data_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE agendalocal.usuario_mensagem_data_seq OWNER TO postgres;

--
-- Name: usuario_mensagem_data_seq; Type: SEQUENCE OWNED BY; Schema: agendalocal; Owner: postgres
--

ALTER SEQUENCE agendalocal.usuario_mensagem_data_seq OWNED BY agendalocal.usuario_mensagem.data;


--
-- Name: usuario_mensagem_id_seq; Type: SEQUENCE; Schema: agendalocal; Owner: postgres
--

CREATE SEQUENCE agendalocal.usuario_mensagem_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE agendalocal.usuario_mensagem_id_seq OWNER TO postgres;

--
-- Name: usuario_mensagem_id_seq; Type: SEQUENCE OWNED BY; Schema: agendalocal; Owner: postgres
--

ALTER SEQUENCE agendalocal.usuario_mensagem_id_seq OWNED BY agendalocal.usuario_mensagem.id;
...
--
-- Name: usuario_anuncio id; Type: DEFAULT; Schema: agendalocal; Owner: postgres
--

ALTER TABLE ONLY agendalocal.usuario_anuncio ALTER COLUMN id SET DEFAULT nextval('agendalocal.usuario_anuncio_id_seq'::regclass);


--
-- Name: usuario_mensagem id; Type: DEFAULT; Schema: agendalocal; Owner: postgres
--

ALTER TABLE ONLY agendalocal.usuario_mensagem ALTER COLUMN id SET DEFAULT nextval('agendalocal.usuario_mensagem_id_seq'::regclass);
...
--
-- Name: usuario_anuncio usuario_anuncio_user_id_fkey; Type: FK CONSTRAINT; Schema: agendalocal; Owner: postgres
--

ALTER TABLE ONLY agendalocal.usuario_anuncio
    ADD CONSTRAINT usuario_anuncio_user_id_fkey FOREIGN KEY (user_id) REFERENCES agendalocal.usuarios(id_usuario);


--
-- Name: usuario_mensagem usuario_mensagem_user_id_fkey; Type: FK CONSTRAINT; Schema: agendalocal; Owner: postgres
--

ALTER TABLE ONLY agendalocal.usuario_mensagem
    ADD CONSTRAINT usuario_mensagem_user_id_fkey FOREIGN KEY (user_id) REFERENCES agendalocal.usuarios(id_usuario);
